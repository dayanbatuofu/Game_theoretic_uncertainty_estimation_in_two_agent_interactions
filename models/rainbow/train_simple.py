...
def train_simple(env, args, writer, log_dir):
    ...
    "mode is entered through terminal (eg --mode)"
    ...
    "import pre-trained models for other car"
    ...
    # state = env.reset()
    "randomize other car's aggressiveness: choosing 1000 or 1"
    ...
    for frame_idx in range(1, args.max_frames + 1):
        ...
        "reverting states for the other agent"
        ...
        "get next state with the actions"
        ...
        # save anyway
        torch.save(state_dict, fname +'.pth')
