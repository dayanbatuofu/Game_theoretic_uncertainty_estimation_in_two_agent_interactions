...
class MachineVehicle:
    ...
    def __init__(self, machine_initial_state, human_initial_state):
        ...
        self.machine_previous_action_set = np.tile((theta_self[1] * C.VEHICLE_MOVEMENT_SPEED * C.ACTION_PREDICTION_MULTIPLIER,
                       theta_self[2] * C.VEHICLE_MOVEMENT_SPEED * C.ACTION_PREDICTION_MULTIPLIER),
                      (t_steps, 1))
        self.human_previous_action_set = np.tile((theta_other[1] * C.VEHICLE_MOVEMENT_SPEED * C.ACTION_PREDICTION_MULTIPLIER,
    ...
    def update(self, human_state):
        ...
        [machine_actions, human_predicted_actions] = self.get_actions(self.human_previous_action_set, self.machine_previous_action_set,
    ...
    def get_actions(self, a0_other, a0_self, s_other, s_self, theta_other, theta_self, t_steps):
    ...
    def loss_func(actions, s_other, s_self, actions_other, theta_self):
        ...
        difference[:, 1] *= C.Y_CLEARANCE_WEIGHT # Weight y differences
