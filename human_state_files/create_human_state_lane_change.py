...
laneChange_speed = C.PARAMETERSET_2.VEHICLE_MAX_SPEED * 0.1
...
for step in range(duration):
    ...
    x += C.PARAMETERSET_2.VEHICLE_MAX_SPEED * 0.75  # Make the human's speed slower than the machine's max speed in order for it to pass

    if laneChange:
        y += laneChange_speed * laneChange_direction
