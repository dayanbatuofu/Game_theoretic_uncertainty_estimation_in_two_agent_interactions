...
class Sim_Data():
    ...
    def append_car1(self, states, actions, action_sets, predicted_theta_of_other, prediction_of_actions_of_other, prediction_of_others_prediction_of_my_actions):
    ...
    def append_car2(self, states, actions, action_sets, predicted_theta_of_other, prediction_of_actions_of_other, prediction_of_others_prediction_of_my_actions):
