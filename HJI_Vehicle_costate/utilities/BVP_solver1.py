...
def solve_bvp1(fun, bc, x, y, p=None, S=None, fun_jac=None, bc_jac=None,
    ...
    while True:
        ...
        for i in range(N):
            ...
            if boundary_line >= position_line and y[2, i] > collision_upper2 and collision == False:
                Istart = i
                Tstart = x[Istart]
                collision = True
            if boundary_line < position_line and y[0, i] > collision_upper1 and collision == False:
                Istart = i
                Tstart = x[Istart]
                collision = True
