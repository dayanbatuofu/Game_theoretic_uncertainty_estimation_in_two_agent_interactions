...
class setup_problem(problem_prototype):
    def __init__(self):
        ...
        self.X0_lb = np.array([[15.1], [18.], [15.], [18.]])
        self.X0_ub = np.array([[15.1], [18.], [15.], [18.]])

        # self.X0_lb = np.array([[18.6], [18.], [18.5], [18.]])
        # self.X0_ub = np.array([[18.6], [18.], [18.5], [18.]])
    ...
    def aug_dynamics(self, t, X_aug):
        ...
        x1_in = (x1 - self.R1 / 2 + self.theta1 * self.W1 / 2) * 10  # 3
        x1_out = -(x1 - self.R1 / 2 - self.W1 / 2 - self.L1) * 10
        x2_in = (x2 - self.R2 / 2 + self.theta2 * self.W2 / 2) * 10
        x2_out = -(x2 - self.R2 / 2 - self.W2 / 2 - self.L2) * 10
